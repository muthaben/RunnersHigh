export declare const StyledButtonGroupButton: import("@stitches/react").StitchesComponentWithAutoCompleteForJSXElements<"button", {}, import("@stitches/react").TMedias & {
    initial: "";
}, {
    colors: {
        elevation1: string;
